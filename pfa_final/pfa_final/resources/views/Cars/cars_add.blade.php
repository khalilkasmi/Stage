                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="card">
                            ...
                            <div class="card-header">Add a Car  </div>
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{route('cars.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="delivery_place" type="text" class="form-control @error('delivery_place') is-invalid @enderror" name="delivery_place" value="{{ old("Delivery place") }}" required autocomplete="Delivery place" autofocus>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="availability_date" type="date" class="form-control @error('availability_date') is-invalid @enderror" name="availability_date" value="{{ old("availability date") }}" required autocomplete="availability date" autofocus>
                                    ...
                                    <input type="hidden" name="agence_id" value="{{ $agency->id }}">
